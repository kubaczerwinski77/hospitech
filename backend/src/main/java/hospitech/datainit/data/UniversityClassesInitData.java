    ...
    public static List<UniversityClass> get(final CourseRepository courseRepository) {
        return List.of(
                new UniversityClass(0, "A1", "333", courseRepository.findByCode("K01w"), LocalTime.of(7, 30),
                        LocalTime.of(9, 0), DayOfTheWeek.MONDAY, "1", StudiesDegree.BA, ModeOfStudies.FULL_TIME),
                new UniversityClass(0, "A1", "333", courseRepository.findByCode("K01c"), LocalTime.of(9, 15),
                        LocalTime.of(11, 0), DayOfTheWeek.TUESDAY, "1", StudiesDegree.BA, ModeOfStudies.FULL_TIME),
                new UniversityClass(0, "A2", "29", courseRepository.findByCode("K01c"), LocalTime.of(13, 15),
                        LocalTime.of(15, 0), DayOfTheWeek.THURSDAY, "1", StudiesDegree.BA, ModeOfStudies.FULL_TIME),
                new UniversityClass(0, "D1", "30", courseRepository.findByCode("K02w"), LocalTime.of(17, 5),
                        LocalTime.of(18, 35), DayOfTheWeek.FRIDAY, "1", StudiesDegree.BA, ModeOfStudies.FULL_TIME),
                new UniversityClass(0, "D2", "127b", courseRepository.findByCode("K02l"), LocalTime.of(9, 15),
                        LocalTime.of(11, 0), DayOfTheWeek.THURSDAY, "1", StudiesDegree.BA, ModeOfStudies.FULL_TIME),
                new UniversityClass(0, "D2", "127b", courseRepository.findByCode("K02l"), LocalTime.of(11, 15),
                        LocalTime.of(13, 0), DayOfTheWeek.THURSDAY, "1", StudiesDegree.BA, ModeOfStudies.FULL_TIME),
                new UniversityClass(0, "D2", "127b", courseRepository.findByCode("K02l"), LocalTime.of(9, 15),
                        LocalTime.of(11, 0), DayOfTheWeek.WEDNESDAY, "1", StudiesDegree.BA, ModeOfStudies.FULL_TIME),
                ...
                new UniversityClass(0, "A4", "12", courseRepository.findByCode("K03w"), LocalTime.of(17, 5),
                        LocalTime.of(18, 45), DayOfTheWeek.MONDAY, "1", StudiesDegree.BA, ModeOfStudies.FULL_TIME),
                new UniversityClass(0, "D2", "333b", courseRepository.findByCode("K03c"), LocalTime.of(18, 55),
                        LocalTime.of(20, 35), DayOfTheWeek.MONDAY, "1", StudiesDegree.BA, ModeOfStudies.FULL_TIME),
                new UniversityClass(0, "D2", "333b", courseRepository.findByCode("K03c"), LocalTime.of(15, 15),
                        LocalTime.of(16, 45), DayOfTheWeek.MONDAY, "1", StudiesDegree.BA, ModeOfStudies.FULL_TIME),
                new UniversityClass(0, "A4", "444", courseRepository.findByCode("K03l"), LocalTime.of(9, 15),
                        LocalTime.of(10, 45), DayOfTheWeek.THURSDAY, "1", StudiesDegree.BA, ModeOfStudies.FULL_TIME),
                new UniversityClass(0, "A4", "444", courseRepository.findByCode("K03l"), LocalTime.of(9, 15),
                        LocalTime.of(10, 45), DayOfTheWeek.TUESDAY, "1", StudiesDegree.BA, ModeOfStudies.FULL_TIME),
                new UniversityClass(0, "D1", "30", courseRepository.findByCode("K04w"), LocalTime.of(11, 15),
                        LocalTime.of(13, 0), DayOfTheWeek.TUESDAY, "1", StudiesDegree.BA, ModeOfStudies.FULL_TIME),
                new UniversityClass(0, "D1", "127a", courseRepository.findByCode("K04l"), LocalTime.of(11, 15),
                        LocalTime.of(13, 0), DayOfTheWeek.WEDNESDAY, "1", StudiesDegree.BA, ModeOfStudies.FULL_TIME),
                new UniversityClass(0, "D1", "127a", courseRepository.findByCode("K04l"), LocalTime.of(11, 15),
                        LocalTime.of(13, 0), DayOfTheWeek.MONDAY, "1", StudiesDegree.BA, ModeOfStudies.FULL_TIME),
                new UniversityClass(0, "D1", "127a", courseRepository.findByCode("K04l"), LocalTime.of(11, 15),
                        LocalTime.of(13, 0), DayOfTheWeek.FRIDAY, "1", StudiesDegree.BA, ModeOfStudies.FULL_TIME),
                new UniversityClass(0, "A1", "333", courseRepository.findByCode("K05w"), LocalTime.of(7, 30),
                        LocalTime.of(9, 0), DayOfTheWeek.FRIDAY, "1", StudiesDegree.BA, ModeOfStudies.FULL_TIME),
                new UniversityClass(0, "A1", "123", courseRepository.findByCode("K05c"), LocalTime.of(9, 15),
                        LocalTime.of(10, 45), DayOfTheWeek.MONDAY, "1", StudiesDegree.BA, ModeOfStudies.FULL_TIME),
                new UniversityClass(0, "A1", "123", courseRepository.findByCode("K05c"), LocalTime.of(11, 0),
                        LocalTime.of(13, 45), DayOfTheWeek.MONDAY, "1", StudiesDegree.BA, ModeOfStudies.FULL_TIME),
                new UniversityClass(0, "A1", "123", courseRepository.findByCode("K05c"), LocalTime.of(7, 30),
                        LocalTime.of(9, 0), DayOfTheWeek.TUESDAY, "1", StudiesDegree.BA, ModeOfStudies.FULL_TIME),
                new UniversityClass(0, "A1", "333", courseRepository.findByCode("K06w"), LocalTime.of(15, 15),
                        LocalTime.of(17, 0), DayOfTheWeek.WEDNESDAY, "1", StudiesDegree.BA, ModeOfStudies.FULL_TIME),
                new UniversityClass(0, "A1", "333", courseRepository.findByCode("K06c"), LocalTime.of(17, 5),
                        LocalTime.of(18, 35), DayOfTheWeek.WEDNESDAY, "1", StudiesDegree.BA, ModeOfStudies.FULL_TIME),
                new UniversityClass(0, "D1", "234a", courseRepository.findByCode("K06c"), LocalTime.of(18, 55),
                        LocalTime.of(20, 35), DayOfTheWeek.WEDNESDAY, "1", StudiesDegree.BA, ModeOfStudies.FULL_TIME),
                new UniversityClass(0, "D1", "333", courseRepository.findByCode("K06c"), LocalTime.of(15, 15),
                        LocalTime.of(17, 0), DayOfTheWeek.FRIDAY, "1", StudiesDegree.BA, ModeOfStudies.FULL_TIME),
                new UniversityClass(0, "A1", "333", courseRepository.findByCode("K06c"), LocalTime.of(17, 5),
                        LocalTime.of(18, 35), DayOfTheWeek.FRIDAY, "1", StudiesDegree.BA, ModeOfStudies.FULL_TIME)
